...
// ========================== options
// let fullDayOptions = document.getElementById('fullDayOptions');
// let halfDayOptions = document.getElementById('halfDayOptions');
// let halfDayOption = document.getElementById('halfDay');
// let fullDayOption = document.getElementById('fullDay');
// halfDayOption.addEventListener('click', ()=> {
    
//     halfDayOptions.classList.remove('d-none');
//     halfDayOption.classList.add('d-none');
    
// });
// fullDayOption.addEventListener('click', ()=> {
    
//     fullDayOptions.classList.remove('d-none');
//     fullDayOption.classList.add('d-none');
